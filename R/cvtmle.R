...
#' @param kappa maximum allowable probability of treating a randomly drawn individual in the population with the second treatment in \code{txs}. The default of 1 indicates no constraint.
